...
\section{Oggetto dell'esercizio}\label{sec:oggetto}
...
\section{Economia di riferimento}\label{sec:economia}
...
\section{Deformazione e contenuto economico}\label{sec:deformazione}
...
\section{Risposta aggregata del consumo}\label{sec:aggregato}
...
\section{Valore dei momenti distributivi}\label{sec:distributivi}
...
\section{Scala fra canale aggregato e canale idiosincratico}\label{sec:neff}
